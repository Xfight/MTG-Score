...
@synthesize dateFormat, gameHistory;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForManagedObject:(NSManagedObject *)managedObject
{
    ...
    GameSingle *gameSingle = (GameSingle *) managedObject;
    NSString *s = [self.dateFormat stringFromDate:gameSingle.timestamp];
    s = [NSString stringWithFormat:@"%@ Game %d", s, [gameSingle.numberGame intValue]];
